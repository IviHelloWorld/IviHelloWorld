...
# ¡Hola mundo! / Hello World! 👋 (`IviHelloWorld`)
...
* 🐍 **Dominio principal:** Dios de Python (Descubriendo librerias y todo uso analitco de python).
*  **Nivel principiante:** Gusano de Lenguaje C (No me gusta).
*  **En constante aprendizaje:** AWS, SQL, Excel y Power BI, ya que seré un analista de datos. También Java, HTML y CSS, ya que me veo en la necesidad de diseñar mis propias cosas.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/0da17d6a-8949-426a-b176-0ba3feb485b3" width="280" alt="witch king" />
  <br><br>
   <i>"¡No te interpongas entre el Nazgûl y su presa!"</i><br>
  <i>"Come not between the Nazgûl and his prey!"</i><br>
  — <b>The Witch-king of Angmar</b>
</p>
